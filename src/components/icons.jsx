...
/* Marks for the "how it works" steps. Stroked rather than filled, to sit at
   the same weight as the rest of the page's line work. */
const stroke = {
  fill: 'none',
  stroke: 'currentColor',
  strokeWidth: 1.6,
...
/** Access: a key — who may open the page at all. */
export const IconKey = ({ size = 20 }) => (
...
/** Measure: a gauge — a reading taken repeatedly, not a verdict. */
export const IconGauge = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" {...stroke}>
...
/** Diagnose: a magnifier over a document — where the influence is lost. */
export const IconInspect = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" {...stroke}>
    <path d="M14 3.5H6.5A1.5 1.5 0 0 0 5 5v14a1.5 1.5 0 0 0 1.5 1.5h5"/>
    <path d="M8.5 7.5h6M8.5 11h3"/>
    <circle cx="16" cy="15" r="3.5"/>
    <path d="M18.6 17.6L21 20"/>
  </svg>
);

/** Act: a checklist — findings that acquired an owner. */
export const IconChecklist = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" {...stroke}>
