      ...
      <div className="container-wide" style={{ position: 'relative' }}>
        <Reveal variant="up">
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/" className="btn btn-cobalt btn-lg">{t('notFound.backHome')} <ArrowRight/></Link>
            <Link to="/pricing" className="btn btn-lg" style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(244,239,230,0.2)', color: 'var(--cream)', borderRadius: 999, padding: '14px 22px', fontSize: 15, display: 'inline-flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>{t('notFound.viewPricing')}</Link>
          </div>
        </Reveal>
      </div>
    </section>
